    ...
    <div class="">
      <div class="min-h-screen flex flex-col items-center justify-center">
        <div class="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
            ...
            <form>
              <div class="mb-12">
                ...
                <p class="text-sm mt-4 text-gray-800">
                  ...
                  <a
                    ...
                    class="text-[#426467] font-semibold hover:underline ml-1 whitespace-nowrap"
                  >
                    Register here
                  </a>
                </p>
              ...
              <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
                <div class="flex items-center">
                  ...
                  <label
                    for="remember-me"
                    class="ml-3 block text-sm text-[#426467]"
                  >
                    Remember me
                  </label>
                </div>
                <div>
                  <a
                    ...
                    class="text-[#426467] font-semibold text-sm hover:underline"
                  >
                    Forgot Password?
                  </a>
                </div>
              ...
              <div class="mt-12">
                <button
                  type="button"
                  class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-[#426467] focus:outline-none"
                >
                  Sign in
                </button>
              </div>
          ...
          <div class="md:h-full bg-[#426467] rounded-xl lg:p-12 p-8">
            <img
